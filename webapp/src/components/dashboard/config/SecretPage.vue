<template>
    <v-row>
        ...
        <DescribeResource :show.sync="showDescribeDialog" resource-name='secret' :resource="selectResource" />
        <ShowSecret :show.sync="showConfigMapDialog" :resource="selectResource" />
    </v-row>
</template>

<script>
import { SecretTable } from '@/assets/app/tables';

import TableRefreshBtn from '../../plugins/TableRefreshBtn.vue';
import DescribeResource from '../dialogs/DescribeResource.vue';
import ShowSecret from './dialogs/ShowSecret.vue';
